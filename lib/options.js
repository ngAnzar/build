...
var Options = exports.Options = function () {
    function Options() {
        ...
        this.set("package", function () {
            console.log("package", _this.package_path, _path2.default.join(_this.package_path, "package.json"));
            if (_package_json === null) {
                _package_json = JSON.parse(_fs2.default.readFileSync(_path2.default.join(_this.package_path, "package.json")));
            }
