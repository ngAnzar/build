...
var resolvers = [function (name) {
    var resolved = [_resolve3.default.sync(name, { basedir: _options.options.package_path }), _resolve3.default.sync(name, { basedir: _path2.default.resolve(_path2.default.join(__dirname, "..", "..")) })];
    ...
    try {
        for (var _iterator = resolved[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (r) {
                if (isDirectory(r)) {
                    r = _path2.default.join(r, "webpack.config.js");
                }
